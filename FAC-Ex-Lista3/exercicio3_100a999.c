...
também será um único número!
  */
  ...
  primeiramente inicializo as variavel de entrada do usuario, que nesse caso é
  apenas uma, o n1 e as de saida e auxilio; em seguida, a logica completa do
  ...
  unidade então não há o que fazer, depois disso, posso compara-los usando um
  algoritmo de ordenação, nesse caso escolhi o de seleção, onde a ideia é trocar
  ...
  casa para direita e a dezena tomaria seu lugar, estando no lugar da dezena,
  comparariamos logo com a unidade, caso seja maior, a centena tomaria o lugar
  ...
  // output
  int n2;
  // variaveis correspondentes para centenas, dezenas e unidades
